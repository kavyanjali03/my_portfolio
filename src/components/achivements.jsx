...
import gssoc from '../../public/GSSOC.jpg'; // rename your uploaded image to gssoc.png and place it in /public
...
function Achievements() {
  return (
    <div className="fixed inset-0 w-screen h-screen bg-gradient-to-br from-orange-100 via-amber-100 to-orange-200 overflow-auto">
      <div className="min-h-full flex flex-col items-center justify-center p-4 sm:p-6 lg:p-8 space-y-10">

        {/* Card 1 - Published Book Chapter */}
        <div className="max-w-5xl w-full bg-white rounded-3xl shadow-2xl p-6 md:p-10 lg:p-12 transform scale-[0.95]">
            ...
            <div className="flex justify-center lg:justify-start">
              <div className="bg-gradient-to-br from-amber-100 to-orange-200 rounded-2xl p-1 shadow-md w-72">
                <div className="bg-white rounded-2xl overflow-hidden">
                  <img src={urop} alt="Book Publication" className="w-full h-auto object-cover" />
                </div>
              </div>
            </div>
        ...
        {/* Card 2 - GirlScript Summer of Code */}
        <div className="max-w-5xl w-full bg-white rounded-3xl shadow-2xl p-6 md:p-10 lg:p-12 transform scale-[0.95]">
          <div className="mb-8 text-center lg:text-left">
            <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-amber-900 mb-2">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[300px_1fr] gap-8 lg:gap-10 items-center">
            <div className="flex justify-center lg:justify-start">
              <div className="bg-gradient-to-br from-amber-100 to-orange-200 rounded-2xl p-1 shadow-md w-72">
                <div className="bg-white rounded-2xl overflow-hidden">
                  <img src={gssoc} alt="GirlScript Certificate" className="w-full h-auto object-cover" />
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4 text-center lg:text-left">
              {[
                "Selected as a Contributor for GirlScript Summer of Code 2025.",
                "Collaborated on open-source projects and contributed to real-world codebases.",
                "Earned 10 points through active participation and project involvement.",
                "Enhanced skills in teamwork, GitHub workflow, and collaborative development.",
              ].map((text, i) => (
                <div key={i} className="flex gap-4 justify-center lg:justify-start group">
                  <div className="flex-shrink-0 mt-1">
                    <div className="w-2.5 h-2.5 rounded-full bg-amber-600 group-hover:scale-125 transition-transform"></div>
